    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(upload_to='article/media/', verbose_name='이미지')),
                ('image_converted', models.ImageField(null=True, upload_to='article/converted/')),
                ('contents', models.TextField(max_length=500, verbose_name='내용')),
                ('output', models.ImageField(default='', upload_to='article/media/', verbose_name='결과물')),
                ('exposure_start_date', models.DateField(default=datetime.datetime(2022, 7, 4, 14, 44, 10, 419517, tzinfo=utc), verbose_name='게시 일자')),
