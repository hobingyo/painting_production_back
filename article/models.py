...
class Article(models.Model):
    ...
    image = models.ImageField('이미지', upload_to="image/")
    image_converted = models.FileField(upload_to='paint/', null=True)
    contents = models.TextField('내용', max_length=500)
    output = models.ImageField('결과물', upload_to="output/", default='')
